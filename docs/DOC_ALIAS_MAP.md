...
| --- | --- | --- | --- |
| `docs/10_BUILD/MODULE_06_MANIFESTATION_BOARD.md` | `docs/10_BUILD/MODULE_06_MANIFESTATION_BOARD.md` | Resolved canonical path | Previously missing requested path; created as canonical Module 06 build doc. |
